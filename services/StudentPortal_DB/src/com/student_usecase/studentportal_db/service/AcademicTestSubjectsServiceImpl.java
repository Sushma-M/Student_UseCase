 ...
 */
@Service("StudentPortal_DB.AcademicTestSubjectsService")
public class AcademicTestSubjectsServiceImpl implements AcademicTestSubjectsService {
    ...
    @Autowired
    @Qualifier("StudentPortal_DB.AcademicTestSubjectsDao")
	...
	public AcademicTestSubjects update(AcademicTestSubjects academicTestSubjects) throws EntityNotFoundException {
        ...
        academictestsubjectsId.setStandard(academicTestSubjects.getStandard());
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service StudentPortal_DB for table AcademicTestSubjects to {} format", exportType);
