...
public class AcademicsServiceImpl implements AcademicsService {
    ...
    @Transactional(readOnly = true, value = "StudentPortal_DBTransactionManager")
    @Override
    public Page<AcademicSubjects> findAssociatedAcademicSubjectses(Date academicYear, String standard, Pageable pageable) {
    ...
    @Transactional(readOnly = true, value = "StudentPortal_DBTransactionManager")
    @Override
    public Page<StudentAcademics> findAssociatedStudentAcademicses(Date academicYear, String standard, Pageable pageable) {
