 ...
 * @see GradeDetails
 */
@Service("StudentPortal_DB.GradeDetailsService")
public class GradeDetailsServiceImpl implements GradeDetailsService {
    ...
    @Autowired
    @Qualifier("StudentPortal_DB.GradeDetailsDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service StudentPortal_DB for table GradeDetails to {} format", exportType);
