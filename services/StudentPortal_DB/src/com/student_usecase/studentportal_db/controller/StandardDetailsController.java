...
public class StandardDetailsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StandardDetails getStandardDetails(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StandardDetails editStandardDetails(@PathVariable("id") String id, @RequestBody StandardDetails standardDetails) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteStandardDetails(@PathVariable("id") String id) throws EntityNotFoundException {
