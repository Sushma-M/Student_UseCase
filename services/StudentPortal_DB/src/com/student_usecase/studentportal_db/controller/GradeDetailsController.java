...
import com.student_usecase.studentportal_db.GradeDetails;
import com.student_usecase.studentportal_db.Results;
import com.student_usecase.studentportal_db.service.GradeDetailsService;

/**
 * Controller object for domain model class GradeDetails.
 * @see GradeDetails
 */
@RestController("StudentPortal_DB.GradeDetailsController")
@Api(value = "GradeDetailsController", description = "Exposes APIs to work with GradeDetails resource.")
@RequestMapping("/StudentPortal_DB/GradeDetails")
public class GradeDetailsController {
    ...
    @Autowired
    @Qualifier("StudentPortal_DB.GradeDetailsService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public GradeDetails getGradeDetails(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public GradeDetails editGradeDetails(@PathVariable("id") Integer id, @RequestBody GradeDetails gradeDetails) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteGradeDetails(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<GradeDetails> findGradeDetails(Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering GradeDetails list");
    ...
    @ApiOperation(value = "Returns the total count of GradeDetails instances.")
