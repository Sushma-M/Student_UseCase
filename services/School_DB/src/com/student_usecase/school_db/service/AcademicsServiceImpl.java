...
public class AcademicsServiceImpl implements AcademicsService {
	...
	public Academics create(Academics academics) {
        ...
        if(academicsCreated.getSubjectses() != null) {
            for(Subjects subjectse : academicsCreated.getSubjectses()) {
                subjectse.setAcademics(academicsCreated);
                LOGGER.debug("Creating a new child Subjects with information: {}", subjectse);
                subjectsService.create(subjectse);
            }
        }
    ...
    @Transactional(readOnly = true, value = "School_DBTransactionManager")
    @Override
    public Page<Subjects> findAssociatedSubjectses(Date academicYear, String standard, Pageable pageable) {
        LOGGER.debug("Fetching all associated subjectses");

        StringBuilder queryBuilder = new StringBuilder();
        queryBuilder.append("academics.academicYear = '" + academicYear + "'");
        queryBuilder.append(" and ");
        queryBuilder.append("academics.standard = '" + standard + "'");

        return subjectsService.findAll(queryBuilder.toString(), pageable);
    }
