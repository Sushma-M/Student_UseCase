...
public interface Table51Service {
     ...
     */
	Table51 create(Table51 table51);
	 ...
	 */
	Table51 getById(String table51Id) throws EntityNotFoundException;
	 ...
	 * @return Table51 associated with the given table51Id.
	 */
	Table51 findById(String table51Id);
	 ...
	 */
	Table51 update(Table51 table51) throws EntityNotFoundException;
	 ...
	 */
	Table51 delete(String table51Id) throws EntityNotFoundException;
