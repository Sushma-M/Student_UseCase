...
public class AcademicTestSubjectsServiceImpl implements AcademicTestSubjectsService {
	...
	public AcademicTestSubjects create(AcademicTestSubjects academicTestSubjects) {
        ...
        if(academicTestSubjectsCreated.getResultses() != null) {
            for(Results resultse : academicTestSubjectsCreated.getResultses()) {
                resultse.setAcademicTestSubjects(academicTestSubjectsCreated);
    ...
    @Transactional(readOnly = true, value = "School_DBTransactionManager")
    @Override
    public Page<Results> findAssociatedResultses(String academicYear, Integer standardId, Integer testId, Integer subjectId, Pageable pageable) {
