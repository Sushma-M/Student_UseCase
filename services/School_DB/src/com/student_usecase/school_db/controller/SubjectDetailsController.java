...
public class SubjectDetailsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<SubjectDetails> findSubjectDetails(Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
    ...
    @ApiOperation(value = "Returns the total count of SubjectDetails instances.")
