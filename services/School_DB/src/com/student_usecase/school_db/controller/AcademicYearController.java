...
import com.student_usecase.school_db.service.AcademicYearService;
...
public class AcademicYearController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AcademicYear getAcademicYear(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AcademicYear editAcademicYear(@PathVariable("id") String id, @RequestBody AcademicYear academicYearInstance) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteAcademicYear(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<AcademicYear> findAcademicYears(Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering AcademicYears list");
    ...
    @ApiOperation(value = "Returns the total count of AcademicYear instances.")
