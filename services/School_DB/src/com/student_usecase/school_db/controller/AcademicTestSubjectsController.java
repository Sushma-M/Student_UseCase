...
import com.student_usecase.school_db.service.AcademicTestSubjectsService;
...
public class AcademicTestSubjectsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AcademicTestSubjects getAcademicTestSubjects(@RequestParam(value = "academicYear", required = true) String academicYear, @RequestParam(value = "standardId", required = true) Integer standardId, @RequestParam(value = "testId", required = true) Integer testId, @RequestParam(value = "subjectId", required = true) Integer subjectId) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AcademicTestSubjects editAcademicTestSubjects(@RequestParam(value = "academicYear", required = true) String academicYear, @RequestParam(value = "standardId", required = true) Integer standardId, @RequestParam(value = "testId", required = true) Integer testId, @RequestParam(value = "subjectId", required = true) Integer subjectId, @RequestBody AcademicTestSubjects academicTestSubjects) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteAcademicTestSubjects(@RequestParam(value = "academicYear", required = true) String academicYear, @RequestParam(value = "standardId", required = true) Integer standardId, @RequestParam(value = "testId", required = true) Integer testId, @RequestParam(value = "subjectId", required = true) Integer subjectId) throws EntityNotFoundException {
        AcademicTestSubjectsId academictestsubjectsId = new AcademicTestSubjectsId();
        academictestsubjectsId.setAcademicYear(academicYear);
        academictestsubjectsId.setStandardId(standardId);
        academictestsubjectsId.setTestId(testId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<AcademicTestSubjects> findAcademicTestSubjects(Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
