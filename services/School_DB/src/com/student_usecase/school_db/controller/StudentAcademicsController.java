...
public class StudentAcademicsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StudentAcademics getStudentAcademics(@RequestParam(value = "studentId", required = true) Integer studentId, @RequestParam(value = "academicYear", required = true) String academicYear, @RequestParam(value = "standardId", required = true) Integer standardId) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StudentAcademics editStudentAcademics(@RequestParam(value = "studentId", required = true) Integer studentId, @RequestParam(value = "academicYear", required = true) String academicYear, @RequestParam(value = "standardId", required = true) Integer standardId, @RequestBody StudentAcademics studentAcademics) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteStudentAcademics(@RequestParam(value = "studentId", required = true) Integer studentId, @RequestParam(value = "academicYear", required = true) String academicYear, @RequestParam(value = "standardId", required = true) Integer standardId) throws EntityNotFoundException {
        StudentAcademicsId studentacademicsId = new StudentAcademicsId();
        studentacademicsId.setStudentId(studentId);
        studentacademicsId.setAcademicYear(academicYear);
        studentacademicsId.setStandardId(standardId);
