...
public class AcademicsController {
    ...
    @RequestMapping(value = "/composite-id/subjectses", method = RequestMethod.GET)
    @ApiOperation(value = "Gets the subjectses instance associated with the given composite-id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Subjects> findAssociatedSubjectses(@RequestParam(value = "academicYear", required = true) Date academicYear, @RequestParam(value = "standard", required = true) String standard, Pageable pageable) {
        LOGGER.debug("Fetching all associated subjectses");
        return academicsService.findAssociatedSubjectses(academicYear, standard, pageable);
    }
