...
public class StandardDetailsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StandardDetails getStandardDetails(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StandardDetails editStandardDetails(@PathVariable("id") Integer id, @RequestBody StandardDetails standardDetails) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteStandardDetails(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<StandardDetails> findStandardDetails(Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
    ...
    @ApiOperation(value = "Returns the total count of StandardDetails instances.")
